...
# Dataproc exposes a single toolset whose generated skill name does not follow a
...
RAW_URL="https://raw.githubusercontent.com/googleapis/mcp-toolbox/v${VERSION}/internal/prebuiltconfigs/tools/dataproc.yaml"
...
generate_skill() {
  ...
  npx "@toolbox-sdk/server@${VERSION}" --prebuilt dataproc skills-generate \
    --name "$SKILL_NAME" \
